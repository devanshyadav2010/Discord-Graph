...
class Stats {
    ...
    async cpu() {
        ...
        const graphUrl = QuickChartHelper.generateLineGraph(cpuData, 'CPU Usage', /* x-axis data */, /* y-axis data */);
    ...
    async ram() {
        ...
        const graphUrl = QuickChartHelper.generateLineGraph(ramData, 'RAM Usage', /* x-axis data */, /* y-axis data */);
    ...
    async servers() {
        ...
        const graphUrl = QuickChartHelper.generateLineGraph(serversData, 'Server Status', /* x-axis data */, /* y-axis data */);
